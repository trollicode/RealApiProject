...
public class Registration extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		DatastoreService ds = DatastoreServiceFactory.getDatastoreService();
	 	...
	 	ArrayList<Float> currentLocation = new ArrayList<>();
	 	currentLocation.add(Float.parseFloat(request.getParameter("latitude")));

	 	currentLocation.add(Float.parseFloat(request.getParameter("longitude")));
	 	String deviceId = request.getParameter("deviceId");
	 	NamespaceManager.set("trolli");
	 	Entity e = new Entity("Registration", simNumber);
	 	...
	 	e.setProperty("deviceId", deviceId);
	 	ds.put(e);
	}
